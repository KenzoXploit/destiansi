...
<head>
    ...
    <title>Wisata Religi Sulawesi Selatan</title>
...
<body>
                ...
                <ul class="navbar-nav me-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item active" href="{{ route('kategori.religi') }}">Objek Wisata Religi</a></li>
    ...
    <div class="hero-section">
        ...
        <div class="hero-content">
            <h1 class="display-4">WISATA RELIGI SULAWESI SELATAN</h1>
            <p class="lead">Temukan tempat-tempat spiritual yang penuh makna di Provinsi Sulawesi Selatan</p>
        </div>
    </div>

    <!-- Daftar Wisata dari Database -->
    <div class="container content-section">
        <h2 class="section-title">DESTINASI WISATA RELIGI</h2>
        <div class="row">
            @forelse($data as $d)
            <div class="col-md-4">
                <div class="card wisata-card position-relative">
                    <img src="{{ asset('uploads/' . $d->gambar) }}" class="card-img-top wisata-img" alt="{{ $d->nama }}">
                    <span class="eco-badge">{{ $d->kategori }}</span>
                    <div class="card-body">
                        <h5 class="card-title">{{ $d->nama }}</h5>
                        <p class="card-text">{{ \Illuminate\Support\Str::limit($d->sejarah, 100) }}</p>
                        <a href="{{ route('detail.show', $d->id_destinasi) }}" class="btn btn-primary">Lihat Detail</a>
                    </div>
                </div>
            </div>
            @empty
                <div class="col-12 text-center">
                    <p>Belum ada data wisata religi.</p>
                </div>
            @endforelse
        </div>
    </div>
